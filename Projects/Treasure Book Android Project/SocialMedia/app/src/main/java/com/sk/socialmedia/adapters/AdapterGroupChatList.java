...
import com.sk.socialmedia.GroupChatActivity;
...
public class AdapterGroupChatList extends RecyclerView.Adapter<AdapterGroupChatList.HolderGroupChatList> {
    ...
    class HolderGroupChatList extends RecyclerView.ViewHolder
    {
        ...
        public HolderGroupChatList(@NonNull View itemView) {
            super(itemView);
            groupIconIv=itemView.findViewById(R.id.groupIconIv_list);
            groupTitleTv=itemView.findViewById(R.id.groupTitleTv);
            nameTv=itemView.findViewById(R.id.nameTv_groupList);
            messageTv=itemView.findViewById(R.id.messageTv_list);
            timeTv=itemView.findViewById(R.id.timeTv_list);
