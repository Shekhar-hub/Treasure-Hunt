...
public class AddPostActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String descriptiion=descriptionEt.getText().toString().trim();
                if (TextUtils.isEmpty(title))
                {
                    Toast.makeText(AddPostActivity.this, "Enter Title...", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (TextUtils.isEmpty(descriptiion))
                {
                ...
                if (isUpdateKey.equals("editPost"))
                {
                    beginUpdate(title,descriptiion,editPostId);
                }
                else
                {
                    uploadData(title,descriptiion);
                }
    ...
    private void beginUpdate(String title, String descriptiion, String editPostId) {
        pd.setMessage("Updating Post...");
        pd.show();
        if (!editImage.equals("noImage"))
        {
            updateWasWithImage(title,descriptiion,editPostId);
        }
        else if (imageIv.getDrawable()!=null)
        {
            updateWithNowImage(title,descriptiion,editPostId);
        }
        else
        {
            updateWithoutImage(title,descriptiion,editPostId);
        }
    }

    private void updateWithoutImage(String title, String descriptiion, String editPostId) {
        ...
        hashMap.put("pDescr", descriptiion);
    ...
    private void updateWasWithImage(final String title, final String descriptiion, final String editPostId) {
    ...
    private void updateWithNowImage(final String title, final String descriptiion, final String editPostId) {
            final String timeStamp=String.valueOf(System.currentTimeMillis());
            String filePathAndName="Posts/"+"post_"+timeStamp;
    ...
    private void uploadData(final String title, final String descriptiion) {
