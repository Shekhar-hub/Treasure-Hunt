...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        try {
            ...
            con = DriverManager.getConnection(str, "project", "12345");
    ...
    private void initComponents() {
        ...
        jPanel1.add(password_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 160, 280, 30));
        jPanel1.add(username_txt, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 100, 280, 30));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 560, 291));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "select * from login_access";
            ...
            if (rs.next()) {
                ...
                do {
                    ...
                    if (username.matches(rs.getString("username"))) {
                        if (password.matches(rs.getString("pass"))) {
                            state = true;
                            break;
             ...
             //state = true;//comment it after completiton
            if (state) {
                JOptionPane.showMessageDialog(this, "Login Successfull");
                if(username.matches("r"))
                        {
                            Assistant_login obj=new Assistant_login(con);
                obj.setVisible(true);
                this.dispose();
                        }
                else
               ...
               Assistant2_login obj=new Assistant2_login(con);
                obj.setVisible(true);
                this.dispose();
                } //x.close();
            } else {
